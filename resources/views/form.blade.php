...
<body class="bg-blue-600">
    <main class="max-w-4xl mx-auto p-6">
        <div class="container mx-auto p-6 bg-white shadow-md rounded-lg">
            <div>
                <h1 class="text-center text-3xl font-bold mt-10">Formulir Pendaftaran Magang Di PT PLN BELAWAN NUSANTARA
                </h1>
            </div>
                ...
                <div class="space-y-12">
                    <div class="border-b border-gray-900/10 pb-12">
                        <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                            ...
                            <div class="sm:col-span-4">
                                <label for="full-name" class="block text-sm font-medium text-gray-900">Nama
                                    Lengkap</label>
                                <div class="mt-2">
                            ...
                            <div class="sm:col-span-3">
                                <label for="jeniskelamin" class="block text-sm font-medium text-gray-900">Jenis
                                    Kelamin</label>
                            ...
                            <div class="sm:col-span-4">
                                <label for="institusi" class="block text-sm font-medium text-gray-900">Nama
                                    Institusi</label>
                                <div class="mt-2">
                            ...
                            <div class="sm:col-span-6">
                                <label for="jurusan" class="block text-sm font-medium text-gray-900">Jurusan/Program
                                    Studi</label>
                                <div class="mt-2">
                            ...
                            <div class="sm:col-span-6">
                                <label for="alasan" class="block text-sm font-medium text-gray-900">Alasan
                                    Pendaftaran</label>
                                <div class="mt-2">
                            ...
                            <div class="sm:col-span-3">
                                <label for="divisi" class="block text-sm font-medium text-gray-900">Pilih Divisi
                                    PKL</label>
                                <div class="mt-2 grid grid-cols-1">
                            ...
                            <div class="col-span-full">
                                <label for="link-surat" class="block text-sm font-medium text-gray-900">Link Surat
                                    Pengantar</label>
                                <div class="mt-2">
