            ...
            <form name='data-pendaftaran-form'>
                <div class="space-y-12">
                    <div class="border-b border-gray-900/10 pb-12">
                        <div class="border-b border-gray-900/10 pb-12">
                            <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                                ...
                                <div class="sm:col-span-6">
                                    <label for="full-name" class="block text-sm/6 font-medium text-gray-900">Nama
                                        Lengkap</label>
                                    <div class="mt-2">
                                        <input type="text" name="nama" id="full-name" autocomplete="name"
                                            class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6"
                        ...
                        <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                            <div class="sm:col-span-4">
                                <label for="institusi" class="block text-sm/6 font-medium text-gray-900">Nama
                                    Institusi</label>
                                <div class="mt-2">
                                    <div
                            ...
                            <div class="sm:col-span-6">
                                <label for="jurusan" class="block text-sm/6 font-medium text-gray-900">Jurusan/Program
                                    Studi</label>
                                <div class="mt-2">
                            ...
                            <div class="sm:col-span-6">
                                <label for="alasan" class="block text-sm/6 font-medium text-gray-900">Alasan
                                    Pendaftaran</label>
                                <div class="mt-2">
                            ...
                            <div class="sm:col-span-3">
                                <label for="country" class="block text-sm/6 font-medium text-gray-900">Pilih Divisi
                                    PKL</label>
                                <div class="mt-2 grid grid-cols-1">
                                    <select id="divisi" name="divisi" autocomplete="divisi-name"
                            ...
                            <div class="col-span-full">
                                <label for="foto" class="block text-sm/6 font-medium text-gray-900">Foto
                                    diri</label>
                                <div class="mt-2">
                            ...
                            <div class="col-span-full">
                                <label for="link-surat" class="block text-sm/6 font-medium text-gray-900">Link Surat
                                    Pengantar</label>
                                <div class="mt-2">
                                    <input type="url" name="pengantar" id="link-surat"
                                        class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6"
                                        placeholder="Masukkan link surat pengantar">
                                </div>
                                <p class="mt-2 text-xs text-gray-500">
                                    Upload surat pengantar Anda dalam format PDF ke Google Drive, lalu kirim
                                    linknya.<br>
                                    <strong>Note:</strong> Pastikan Anda mengizinkan akses untuk public.
                                </p>
                            </div>
...
<script>
    ...
    const scriptURL =
        'https://script.google.com/macros/s/AKfycbxpCBkKTkuq_PCnefd21eUPrFXyok4CP3KQpt4b96GYXJ5-AgzfBhQW9TnP5YT3mT68/exec';
