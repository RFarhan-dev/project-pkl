...
<body>
    <header x-data="{ isOpen: false }" class="bg-yellow-500 sticky top-0 z-50">
        ...
        <div class="lg:hidden" role="dialog" aria-modal="true">
            ...
            <div class="fixed inset-0 z-10" x-show="isOpen" x-transition:enter="transition ease-in-out duration-300"
                ...
                <div class="mt-6 flow-root">
                    <div class="-my-6 divide-y divide-gray-500/10">
                        <div class="space-y-2 py-6">
                            ...
                            <a href="/divisi"
                                class="-mx-3 block rounded-lg px-3 py-2 text-base/7 font-semibold text-gray-900 hover:bg-gray-50">Divisi</a>
                        </div>
                    </div>
                </div>
            </div>
